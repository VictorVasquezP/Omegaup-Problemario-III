#include <stdio.h>
#include <string.h>
void com(char arreglo1[], char arreglo2[], unsigned long inicializar, unsigned long veces, unsigned long tamanno2, int *resultado);
int main(int argc, char *argv[]) {
	...
	com(primerpalabra, segundapalabra, 0, reiteraciones, tamanno2, &veces);
	printf("%d", veces);
	return 0;
}
void com(char arreglo1[], char arreglo2[], unsigned long inicializar, unsigned long veces, unsigned long tamanno2, int *resultado){
	...
	if(inicializar<=veces){
		...
		com(arreglo1, arreglo2, inicializar+1, veces, tamanno2, resultado);
	}
}
